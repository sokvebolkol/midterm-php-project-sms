...
<body>
	...
	<div id="section">
		...
		<div class="content">
			...
			<h3>Add for our new student</h3><br>
			<?php
			if (isset($_POST["submit"])) {
				...
				if (move_uploaded_file($_FILES['img']['tmp_name'], $target_file)) {
					$sq = "insert into student(RNO,NAME,FNAME,DOB,GEN,PHO,MAIL,ADDR,SCLASS,SSEC,SIMG) values('{$_POST["rno"]}','{$_POST["name"]}','{$_POST["fname"]}','{$edate}','{$_POST["gen"]}','{$_POST["pho"]}','{$_POST["email"]}','{$_POST["addr"]}','{$_POST["cla"]}','{$_POST["sec"]}','{$target_file}')";
